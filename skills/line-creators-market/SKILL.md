...
description: Plans, designs, and ships LINE Creators Market submissions — sticker types (static, animated, custom, message, big, popup, effect), emoji and theme creation, technical specs (sizes, APNG, file limits), review guidelines, AI-usage declaration, revenue model, LINE Stickers Premium, LINE Sticker Maker, and market strategy for Japan, Taiwan, Thailand, and global audiences. Use when the user mentions LINE stickers, LINE emoji, LINE themes, Creators Market, sticker submission, sticker review, sticker character design, animated/popup/message/big/effect stickers, AI-generated stickers, or LINE Sticker Maker.
---
...
### Submission & Review
1. Load [references/platform-guide.md](references/platform-guide.md)
...
| [platform-guide.md](references/platform-guide.md) | Creators Market platform operations, review rules, and revenue model |
...
All Creators Market URLs use `https://creator.line.me/{lang}/...`. Match `{lang}` to the user's language (see [platform-guide.md](references/platform-guide.md) for the full mapping). Default to `en` if uncertain.
